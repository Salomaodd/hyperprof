package com.hyperprof.curso.api.professores.validators;
...
public class ProfessorEmailIsUniqueValidator implements ConstraintValidator<ProfessorEmailIsUnique, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext constraintValidatorContext) {
        ...
        var isAuthenticated = authentication != null && !(authentication instanceof AnonymousAuthenticationToken) && authentication.isAuthenticated();
        {
            if (isAuthenticated) {
